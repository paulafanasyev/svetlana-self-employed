...
function InfoPage({ kind }) {
  const pages = {
    ...
    contacts: { eyebrow: 'Контакты', title: 'Связаться с АНО ЦПС «Мир Самозанятых»', text: 'Открыты для обращений самозанятых, предложений о сотрудничестве, учебных программ, проектов и сообщений об ошибках.', sections: [['АНО «Центр поддержки самозанятых «Мир Самозанятых»', 'Юридический адрес: 115612, Москва, ул. Ключевая, дом 18, этаж 1 пом. 6, ком. 11. Фактический адрес: Москва, Варшавское шоссе, дом 76 корпус 2, Коворкинг Центр НКО ЮАО.'], ['Реквизиты', 'ИНН 9724016805 · ОГРН 1207700247864 · КПП 772401001'], ['Связь', 'Телефон: +7 (919) 999-13-36. Email: mir.samozanyatyh@yandex.ru.'], ['Репозиторий', 'GitHub: github.com/paulafanasyev/svetlana-self-employed'], ['Публичные страницы', 'Информация об организации, сотрудничестве и юридических документах доступна из футера.']] },
