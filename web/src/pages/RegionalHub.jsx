    ...
    <>
      ...
      <section className="site-section">
        <div className="site-container">
          ...
          <section className="site-region-partner-cta">
            <div>
              <span className="site-eyebrow">Для организаций</span>
              <h2>У вас есть программа для самозанятых?</h2>
              <p>Учебные и профессиональные центры, работодатели, эксперты, банки, общественные организации и другие партнёры могут предложить программу для конкретного города или региона.</p>
            </div>
            <Link to="/cooperation" className="site-btn site-btn-primary">Предложить сотрудничество →</Link>
          </section>
        </div>
      </section>
    </>
