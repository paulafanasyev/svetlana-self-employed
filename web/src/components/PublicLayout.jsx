...
const QUICK = ['Что такое НПД?', 'Как зарегистрироваться?', 'Что умеет Светлана?', 'Где скачать приложение?'];
...
const ANSWERS = [
  ...
  { keys: ['маркетплейс', 'заказ', 'услуг'], text: 'Маркетплейс объединяет проекты, услуги и отклики. Публичная часть рассказывает о возможностях, а реальные объявления и отклики доступны в рабочем пространстве после входа.' },
